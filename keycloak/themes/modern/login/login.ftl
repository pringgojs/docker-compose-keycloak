<#-- Custom Keycloak login page with Tailwind CSS, hasil konversi dari login.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-green-200 via-white to-green-300 dark:from-neutral-900 dark:via-neutral-800 dark:to-green-900">
    <div class="w-full max-w-md p-8 md:p-10 bg-white/70 dark:bg-neutral-900/80 rounded-3xl shadow-2xl border border-green-200 dark:border-neutral-700 backdrop-blur-lg relative overflow-hidden">
        <div class="absolute -top-10 -right-10 w-40 h-40 bg-green-100 dark:bg-green-900/30 rounded-full blur-2xl opacity-60 z-0"></div>
        <div class="absolute -bottom-10 -left-10 w-40 h-40 bg-green-200 dark:bg-green-800/30 rounded-full blur-2xl opacity-60 z-0"></div>
        ...
        <form id="kc-form-login" method="post" action="${url.loginAction}" class="space-y-6 relative z-10">
            ...
            <div>
                <label for="username" class="block mb-1 text-sm font-semibold text-gray-700 dark:text-gray-200">Email atau Username</label>
                <div class="relative">
            ...
            <div>
                <label for="password" class="block mb-1 text-sm font-semibold text-gray-700 dark:text-gray-200">Password</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-green-400">
                        <!-- Icon lock -->
            ...
            <div class="flex items-center justify-between">
                ...
                <#if realm.resetPasswordAllowed>
                    <a href="${url.loginResetCredentialsUrl}" class="text-sm text-green-600 hover:underline dark:text-green-400 transition-colors">Lupa password?</a>
                </#if>
            </div>
