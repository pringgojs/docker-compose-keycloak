    ...
    <div class="grid lg:grid-cols-2 gap-x-20">
      <div class="max-w-md w-full bg-white dark:bg-gray-800 shadow-2xl rounded-t-xl lg:rounded-2xl relative overflow-hidden z-10">
        <div class="h-20 flex gap-x-2 items-center w-full p-2 bg-white rounded-t-xl dark:bg-gradient-to-r dark:from-gray-800 dark:via-gray-700 dark:to-gray-600">
          <img src="${url.resourcesPath}/css/logo_warna.png" alt="Logo" class="block dark:hidden w-auto h-16" />
          <img src="${url.resourcesPath}/css/logo_hitam-putih.png" alt="Logo Dark" class="hidden dark:block w-auto h-16" />
          <div class="font-bold">
        ...
        <div class="bg-[#fdf1f1] dark:bg-transparent lg:px-2 flex flex-col items-center">
          <div class="flex lg:gap-x-2 lg:pt-3 px-2 mt-4 items-center">
            <img src="${url.resourcesPath}/css/korpri_warna.png" alt="Logo" class="block dark:hidden w-auto h-36 lg:h-42" />
            <img src="${url.resourcesPath}/css/korpri_hitam.png" alt="Logo Dark" class="hidden dark:block w-auto h-36 lg:h-42" />
            ...
            <div class="px-5">
              ...
              <div class="text-xs lg:text-[14px] mt-2 text-gray-700 dark:text-gray-300">Satu akun untuk semua layanan aplikasi ASN Kabupaten Ponorogo</div>
            </div>
          </div>
            ...
            <div class="flex flex-row gap-x-5 items-center p-4 my-4">
              <div>
                <div class="flex justify-center gap-x-2 items-center">
                  <i class="fa-solid fa-lock text-2xl text-red-800 dark:text-gray-400"></i>
              ...
              <div>
                <div class="flex justify-center gap-x-2 items-center">
                  <i class="fa-solid fa-bolt-lightning text-2xl text-red-800 dark:text-gray-400"></i>
              ...
              <div>
                <div class="flex justify-center gap-x-2 items-center">
                  <i class="fas fa-landmark text-2xl text-red-800 dark:text-gray-400"></i>
                  <div class="text-sm font-semibold text-red-800 leading-4 dark:text-gray-300">Resmi Untuk ASN</div>
                </div>
                <div class="mt-1 text-xs leading-3.5 dark:text-gray-300">Hanya untuk Pegawai ASN Kabupaten Ponorogo</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="max-w-md w-full bg-[#fdf1f1] lg:bg-white dark:bg-gray-800 shadow-2xl rounded-b-xl lg:rounded-2xl relative overflow-hidden z-10">
        ...
        <div class="px-8 py-4 lg:py-0 lg:pb-8">
          <div class="bg-yellow-50 dark:bg-yellow-900 border-yellow-200 dark:border-yellow-700 text-sm text-yellow-800 dark:text-yellow-200 rounded-lg p-4" role="alert" tabindex="-1" aria-labelledby="hs-with-description-label">
            <div class="flex">
              <div class="shrink-0">
          ...
          <form id="kc-form-login" method="post" action="${url.loginAction}" class="space-y-4 lg:border-0 shadow-lg border-2 border-gray-200 dark:border-gray-700 p-4 rounded-xl bg-white dark:bg-transparent lg:bg-transparent">
            ...
            <div>
              ...
              <input
                ...
                class="mt-1 w-full px-4 py-2 border rounded-xl shadow-sm focus:ring-blue-500 focus:border-blue-500 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
            ...
            <a href="https://simashebat.ponorogo.go.id/reset-password/" target="_blank" rel="noopener noreferrer" class="text-xs italic dark:text-gray-300 float-end hover:underline">Reset Password</a>
          </form>
        ...
        <div class="lg:hidden">
          <!-- <div class="flex flex-row gap-x-5 items-center p-4 lg:my-4">
            <div>
              <div class="flex justify-center gap-x-2 items-center">
                <i class="fa-solid fa-lock text-2xl text-red-800 dark:text-gray-400"></i>
                <div class="text-sm font-semibold text-red-800 leading-4 dark:text-gray-300">Aman & Terpusat</div>
